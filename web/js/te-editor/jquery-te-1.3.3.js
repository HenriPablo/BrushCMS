...
(function($){
  $.fn.jqte = function(options){
	...
	var varsTitle = [
		...
		{title:"Source"},
        {title:"Insert Image from Lib"},
        {title:"Edit in Ace Editor"}
		];
    ...
    addParams('img',    'img',              '',     ["img"],        false   ); // inserting image
    addParams('ace',    'ace',              '',      '',            false   ); // edit contents in ACE editor
                        ...
                        if( $(this).data('command') == 'img')
                        {
                            ...
                            $.colorbox( { inline:true, href:'#imageBrowser', width: '90%', height: '90%',
                                ...
                                onComplete: function(  ){
                                    ...
                                    $('img', '#imageBrowser').each(  function(){

                                        $(this).on( 'click', function(){
                                            pixSrcToInsert = $(this).attr('src');
                                            console.log( "in onComplete -> colorbox: " + pixSrcToInsert)
                                            alert( x );
                                            selectionSet("insertImage",pixSrcToInsert );
                                ...
                                onCleanup: function(){
                                    console.log( "XXXin' again: " + x  );
                                    console.log( "onCleanup right before insert: " + pixSrcToInsert);
                                    console.log( "onCleanup selection: " + selectionGet() );
                                    console.log( "onCleanup  selectionGet: " + selectionGet().getRangeAt( 0 ) );

                                    return selectionSet("insertImage",pixSrcToInsert );
                                }
                            });  */
                            ...
                            /*
                            var img = document.createElement('img');
                            img.src = p.ss(); //'/brush/art/upload/thm/6-3-2011-Untitled_Panorama1.jpg';
                            ...
                            */
                            ...
                            //selectionSet("insertImage", p.ss() );

                            //console.log( "after -> colorbox call: " + pixSrcToInsert)
                            //console.log( "selection: " + s );
                            //console.log( "selectionGet: " + sg );
                            //alert( selectionGet() );
                            //alert( selectionGet().getRangeAt( 0 ) )
                        }
                        /* end custom pix insert */

                        /* edit in ACE */
                        if( $(this).data('command') == 'ace'){
                            //alert( $('#content').val() );
